export default function ProjectCard({ project, onEmbed, onDomains, onDelete, onAnalytics }) {
  ...
  return (
    <div className="project-card">
      ...
      <div className="project-actions">
        <button className="btn btn-ghost btn-sm" onClick={onAnalytics} title="Analytics">
        ...
        <button className="btn btn-ghost btn-sm" onClick={onEmbed} title="Get embed code">
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <button
          ...
          onMouseEnter={e => {
            e.currentTarget.style.background = 'rgba(229,62,62,.18)';
            e.currentTarget.style.borderColor = 'rgba(229,62,62,.4)';
          }}
          onMouseLeave={e => {
            e.currentTarget.style.background = 'rgba(229,62,62,.08)';
            e.currentTarget.style.borderColor = 'rgba(229,62,62,.2)';
          }}
        >
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
